    ...
    <Card className="p-4 relative overflow-hidden">
      {error && !isPending && (
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center bg-background/40 backdrop-blur-[2px]">
          <div className="bg-destructive/10 border border-destructive px-6 py-3 shadow-lg flex flex-col items-center gap-2 rounded-xl">
            <span className="text-sm font-semibold text-destructive">{error}</span>
            <p className="text-xs text-muted-foreground text-center">Please try again later or check your connection.</p>
          </div>
        </div>
      )}
        ...
        ">
          <div className="bg-background border border-border
            ...
            <p className="text-xs text-muted-foreground text-center">
              Start tracking your website to see analytics here.</p>
          </div>
        </div>
      )}
      ...
      ">
        ...
        transition-colors"
            ...
            <Separator
              ...
              className="my-2! bg-border h-15! self-center last:hidden"
            />
          </React.Fragment>
        ))}
